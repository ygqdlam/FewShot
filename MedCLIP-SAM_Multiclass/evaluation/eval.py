...
for name in tqdm(filenames):
    ...
    print("000000000000",join(gt_path, name))
    print("000000000000000",join(seg_path, name))
    ...
    seg_mask = cv2.threshold(seg_mask, 0, 255, cv2.THRESH_BINARY)[1]
    ...
    print("111111111",np.count_nonzero(gt_labels))
    print("222222222222222",np.count_nonzero(seg_labels))
