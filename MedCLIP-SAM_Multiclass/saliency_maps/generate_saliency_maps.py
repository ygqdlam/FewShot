...
# "0": "background", "1": "spleen", "2": "right kidney", "3": "left kidney", "4": "gallbladder", "5": "esophagus", "6": "liver", "7": "stomach", "8": "Pancreas"
### MulitClass
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=True, default="synapse", type=str, help='select dataset')
